...
If you're a DFIR analyst on Linux, you know the struggle of finding professional forensic tools that run natively. I built IRFlow Timeline so analysts on any OS can triage timelines at speed.
