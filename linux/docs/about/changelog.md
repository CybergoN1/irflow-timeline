...
- **Row Checkbox Selection** — Checkbox column in the data grid
  ...
  - Copy Selected Rows (`Ctrl+C`) and Export Selected Rows as CSV
...
- **Recent Files** — Persistent list of recently opened files
  ...
  - Native Linux "Open Recent" menu integration
...
- **Context menu** — glass/blur aesthetic with inline SVG icons
...
- Linux native (x86_64, AppImage + .deb)
