...
- `Ctrl+Click` a tagged row and select **Remove Tag**
...
- **Stacking** — `Ctrl+Click` the Tags header and select Stack Values to see tag frequency distribution
