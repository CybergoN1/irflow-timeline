...
- Linux desktop integration (file associations, single-instance lock)
...
| **AppImage** | `npm run dist:appimage` | Portable, any Linux distro |
| **`.deb`** | `npm run dist:deb` | Debian/Ubuntu package |
