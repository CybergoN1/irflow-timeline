...
- Windows integration (taskbar, file associations, single-instance lock)
...
| **NSIS Installer** | `npm run dist:nsis` | Windows setup wizard |
| **Portable** | `npm run dist:portable` | Single `.exe`, no install |
